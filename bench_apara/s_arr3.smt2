...
(rule (=> (and (inv0 a2 i C1 C2 x n elem) (>= i n)) (inv1 a i C1 C2 x n elem)))

(rule (=> (and (inv1 a i C1 C2 x n elem) (<= i (div n 2))
  (= a1 (store a i C1))
  (= a2 (ite (= i x) (store a1 0 C2) a1))
  (= x1 (ite (= i x) (+ x 5) x))
  (= i1 (+ i 1))) (inv1 a2 i1 C1 C2 x1 n (select a2 i))))
  
(rule (=> (and (inv1 a i C1 C2 x n elem) (> i (div n 2))) (inv2 a i C1 C2 x n elem) ))

(rule (=> (and (inv2 a i C1 C2 x n elem) (> i (div n 2))
  (= a1 (store a i C1))
  (= a2 (ite (= i x) (store a1 0 C2) a1))
  (= x1 (ite (= i x) (+ x 5) x))
  (= i1 (+ i 1))) (inv1 a2 i1 C1 C2 x1 n (select a1 i))))

(rule (=> (and (inv0 a0 i C1 C2 x n elem) (inv2 a2 i C1 C2 x n elem) (>= i n)
